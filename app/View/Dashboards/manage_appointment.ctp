                  ...
                  <tbody>
                    <?php $i=0;
                      ...
                      ?></td>
                            ...
                            <td><?php  $appointTimeDet=isset($appointment['Appointment']['appoint_book_slut']) ? $this->Custom->AppointmentTimeAvailDetail($appointment['Appointment']['appoint_book_slut']) : "";
                                        if($appointTimeDet!=""){
                                            echo $appointTimeDet;
                                        }else{
                            ...
                            <td width="20%">
                              <?php echo $this->Html->link(__('Edit'), array('action' => 'EditAppointment', $appointment['Appointment']['id']),array('class'=>'btn btn-primary')); ?>
